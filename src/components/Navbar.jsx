  ...
  {isOpen && (
    <div className="absolute top-full left-0 w-[70%] border   transition ease-in-out duration-500  overflow-scroll  bg-white  h-screen">
      <ul className="flex flex-col  gap-4 p-4 text-gray-700 font-semibold px-5 ">
        <li><NavLink to="/" onClick={handleToggleClose}>Home</NavLink></li>
        <li><NavLink to="/shop" onClick={handleToggleClose}>Shop</NavLink></li>
        <li><NavLink to="/pages" onClick={handleToggleClose}>Pages</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Elements</NavLink></li>
        
      </ul>
      <hr className="w-full text-neutral-600" />
      <ul className="flex flex-col  gap-4 p-4 text-gray-700 font-semibold px-5 ">
        <li><NavLink to="/shop" onClick={handleToggleClose}>New Arrival</NavLink></li>
        <li><NavLink to="/shop" onClick={handleToggleClose}>Cult Favourites</NavLink></li>
        <li><NavLink to="/pages" onClick={handleToggleClose}>Clothing</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Pants</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Denims</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Tees</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Sweater</NavLink></li>
        <li><NavLink to="/element" onClick={handleToggleClose}>Brands</NavLink></li>
      </ul>
      
      <ul className="flex flex-col  gap-4 p-4 text-gray-700 font-semibold px-5 ">
        <li >
          <NavLink to={`/product/${product._id}`} onClick={handleToggleClose}>
